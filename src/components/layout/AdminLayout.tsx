  ...
  const navSections = [
    ...
    ...(isAdmin ? [{
      ...
      items: [
        ...
        { path: '/dashboard/settings/canned-responses', icon: FileText, label: 'Canned Responses' },
        { path: '/dashboard/settings/ticket-templates', icon: Ticket, label: 'Ticket Templates' },
        { path: '/dashboard/settings/auto-assignment', icon: Zap, label: 'Auto-Assignment' },
          ...
          {!desktopSidebarCollapsed ? (
            ...
            <div className="w-full flex flex-col items-center justify-between h-full py-2">
              ...
              <Button
                ...
                className="h-8 w-8 p-1 text-foreground hover:bg-muted -mb-2 relative z-10"
