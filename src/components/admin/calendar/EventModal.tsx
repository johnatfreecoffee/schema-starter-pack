      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <Input id="title" {...register('title', { required: true })} placeholder="e.g., Client meeting with John Smith" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input id="start_time" type={allDay ? 'date' : 'datetime-local'} {...register('start_time', { required: true })} />
            </div>
            <div>
              <Label htmlFor="end_time">End {!allDay && 'Time'} *</Label>
              <Input id="end_time" type={allDay ? 'date' : 'datetime-local'} {...register('end_time', { required: true })} />
            </div>
          </div>

          <div>
            <Label htmlFor="description">Description</Label>
            <Textarea id="description" {...register('description')} rows={4} placeholder="Add details, agenda, notes..." />
          </div>

          <div>
            <Label htmlFor="location">Location</Label>
            <Input id="location" {...register('location')} placeholder="e.g., Conference Room A, Customer Site, Zoom" />
          </div>
