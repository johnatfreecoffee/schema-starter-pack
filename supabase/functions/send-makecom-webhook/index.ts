...
// Load builder stage instructions from markdown file
const builderStageInstructions = await Deno.readTextFile(
  new URL('./builder-stage-instructions.md', import.meta.url).pathname
);
